    ...
    lineBarsData: [
      LineChartBarData(
        spots: [
          ...
          FlSpot(0.151 * 5, 0.6032 * 5),
          FlSpot(0.152 * 5, 0.6832 * 5),
          FlSpot(0.153 * 5, 0.7520 * 5),
          FlSpot(0.154 * 5, 0.8081 * 5),
          FlSpot(0.155 * 5, 0.8526 * 5),
          FlSpot(0.156 * 5, 0.8847 * 5),
          FlSpot(0.157 * 5, 0.9020 * 5),
          FlSpot(0.158 * 5, 0.8932 * 5),
          FlSpot(0.159 * 5, 0.8701 * 5),
          FlSpot(0.160 * 5, 0.8415 * 5),
          FlSpot(0.161 * 5, 0.8145 * 5),
          FlSpot(0.162 * 5, 0.7970 * 5),
          FlSpot(0.163 * 5, 0.7933 * 5),
          FlSpot(0.164 * 5, 0.8064 * 5),
          FlSpot(0.165 * 5, 0.8278 * 5),
          FlSpot(0.166 * 5, 0.8410 * 5),
          FlSpot(0.167 * 5, 0.8361 * 5),
          FlSpot(0.168 * 5, 0.8177 * 5),
          FlSpot(0.169 * 5, 0.7865 * 5),
          FlSpot(0.170 * 5, 0.7526 * 5),
          FlSpot(0.171 * 5, 0.7080 * 5),
          FlSpot(0.172 * 5, 0.6521 * 5),
          FlSpot(0.173 * 5, 0.5922 * 5),
          FlSpot(0.174 * 5, 0.5366 * 5),
          FlSpot(0.175 * 5, 0.4952 * 5),
          FlSpot(0.176 * 5, 0.4735 * 5),
          FlSpot(0.177 * 5, 0.4780 * 5),
          FlSpot(0.178 * 5, 0.5079 * 5),
          FlSpot(0.179 * 5, 0.5486 * 5),
          FlSpot(0.180 * 5, 0.5829 * 5),
          FlSpot(0.181 * 5, 0.6090 * 5),
          FlSpot(0.182 * 5, 0.6266 * 5),
          FlSpot(0.183 * 5, 0.6339 * 5),
          FlSpot(0.184 * 5, 0.6575 * 5),
          FlSpot(0.185 * 5, 0.7215 * 5),
          FlSpot(0.186 * 5, 0.7691 * 5),
          FlSpot(0.187 * 5, 0.7700 * 5),
          FlSpot(0.188 * 5, 0.7514 * 5),
          FlSpot(0.189 * 5, 0.7245 * 5),
          FlSpot(0.190 * 5, 0.6656 * 5),
          FlSpot(0.191 * 5, 0.5534 * 5),
          FlSpot(0.192 * 5, 0.3842 * 5),
          FlSpot(0.193 * 5, 0.2307 * 5),
          FlSpot(0.194 * 5, 0.0687 * 5),
          FlSpot(0.195 * 5, -0.001 * 5),
          FlSpot(0.196 * 5, 0.0106 * 5),
          FlSpot(0.197 * 5, 0.00006 * 5),
          FlSpot(0.198 * 5, -0.0004 * 5),
          FlSpot(0.199 * 5, 0.0134 * 5),
          FlSpot(0.200 * 5, -0.0001 * 5),
        ],
        isCurved: true,
